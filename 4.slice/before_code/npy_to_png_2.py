...
def main():
    ...
    input_dirs = [
        "/Users/iujeong/03_meningioma/4.slice/s_test2/npy",
        "/Users/iujeong/03_meningioma/4.slice/s_train2/npy",
        "/Users/iujeong/03_meningioma/4.slice/s_val2/npy",
    ]
    ...
    for input_dir in input_dirs:
        ...
        for img_path in tqdm(img_paths, desc=f"Visualizing {split_name}"):
            ...
            img = np.flipud(img)  # 방향 보정 제거, 원본 shape 유지 (192, 160)
