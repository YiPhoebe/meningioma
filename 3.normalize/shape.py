...
# 세 경로 지정
base_paths = {
    "train": Path("/Users/iujeong/03_meningioma/3.normalize/n_train"),
    "val": Path("/Users/iujeong/03_meningioma/3.normalize/n_val"),
    "test": Path("/Users/iujeong/03_meningioma/3.normalize/n_test"),
}
...
df.to_csv("/Users/iujeong/03_meningioma/3.normalize/norm_volume_shapes.csv", index=False)
print(df)