...
import torch
from model.UNet_3 import UNet_3  # 또는 nnUNet 등
...
# ✅ 설정
BATCH_SIZE = 8
MODEL_PATH = "/Users/iujeong/03_meningioma/6.modelling/result/pth/250712_2_epoch_036_dice_0.7823_best.pth"
...
# ✅ 모델 불러오기
model = UNet_3(in_channels=1, out_channels=1)
